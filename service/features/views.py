...
from service.features.tasks import import_features_from_git_repo
...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    def features(self, request, pk=None):
        ...
        if request.method == "POST":
            project.set_status(Project.STATUS_ADDING)
            import_features_from_git_repo.delay(project.id)
